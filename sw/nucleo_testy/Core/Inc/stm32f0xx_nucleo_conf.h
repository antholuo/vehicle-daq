...
#ifndef STM32F0XX_NUCLEO_CONF_H
#define STM32F0XX_NUCLEO_CONF_H
...
/** @defgroup STM32F0XX_NUCLEO_CONFIG Config
  * @{
  */

/** @defgroup STM32F0XX_NUCLEO_CONFIG_Exported_Constants
  * @{
  */
/* COM Feature define */
