...
#ifndef STM32F0XX_NUCLEO_BUS_H
#define STM32F0XX_NUCLEO_BUS_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f0xx_nucleo_conf.h"
#include "stm32f0xx_nucleo_errno.h"
...
/** @defgroup STM32F0XX_NUCLEO_BUS STM32F0XX_NUCLEO BUS
  * @{
  */

/** @defgroup STM32F0XX_NUCLEO_BUS_Exported_Constants STM32F0XX_NUCLEO BUS Exported Constants
  * @{
  */
...
/** @defgroup STM32F0XX_NUCLEO_BUS_Private_Types STM32F0XX_NUCLEO BUS Private types
  * @{
  */
...
/** @defgroup STM32F0XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup STM32F0XX_NUCLEO_BUS_Exported_Functions
  * @{
  */
