...
/* Includes ------------------------------------------------------------------*/
#include "stm32f0xx_nucleo_bus.h"
...
/** @defgroup STM32F0XX_NUCLEO_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32F0XX_NUCLEO_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32F0XX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STM32F0XX_NUCLEO_LOW_LEVEL_Private_Functions STM32F0XX_NUCLEO LOW LEVEL Private Functions
  * @{
  */

/** @defgroup STM32F0XX_NUCLEO_BUS_Exported_Functions STM32F0XX_NUCLEO_BUS Exported Functions
  * @{
  */
