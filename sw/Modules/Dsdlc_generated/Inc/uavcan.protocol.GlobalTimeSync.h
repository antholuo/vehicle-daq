...
uint32_t uavcan_protocol_GlobalTimeSync_encode(
    struct uavcan_protocol_GlobalTimeSync *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_protocol_GlobalTimeSync_decode(
    const CanardRxTransfer *transfer,
    struct uavcan_protocol_GlobalTimeSync *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_protocol_GlobalTimeSync_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_protocol_GlobalTimeSync *msg, bool tao);
static inline bool _uavcan_protocol_GlobalTimeSync_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_protocol_GlobalTimeSync *msg, bool tao);
void _uavcan_protocol_GlobalTimeSync_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_protocol_GlobalTimeSync *msg, bool tao) {
  (void)buffer;
  (void)bit_ofs;
  ...
  canardEncodeScalar(buffer, *bit_ofs, 56,
...
*/
bool _uavcan_protocol_GlobalTimeSync_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_protocol_GlobalTimeSync *msg, bool tao) {
  (void)transfer;
  (void)bit_ofs;
  ...
  canardDecodeScalar(transfer, *bit_ofs, 56, false,
                     &msg->previous_transmission_timestamp_usec);
...
struct uavcan_protocol_GlobalTimeSync sample_uavcan_protocol_GlobalTimeSync_msg(
    void);
#endif
#ifdef __cplusplus
}  // extern "C"
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_protocol_GlobalTimeSync,
                            UAVCAN_PROTOCOL_GLOBALTIMESYNC_ID,
                            UAVCAN_PROTOCOL_GLOBALTIMESYNC_SIGNATURE,
