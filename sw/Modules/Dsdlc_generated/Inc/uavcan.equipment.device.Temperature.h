...
uint32_t uavcan_equipment_device_Temperature_encode(
    struct uavcan_equipment_device_Temperature *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_equipment_device_Temperature_decode(
    const CanardRxTransfer *transfer,
    struct uavcan_equipment_device_Temperature *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_equipment_device_Temperature_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_device_Temperature *msg, bool tao);
static inline bool _uavcan_equipment_device_Temperature_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_device_Temperature *msg, bool tao);
void _uavcan_equipment_device_Temperature_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_device_Temperature *msg, bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
/*
 decode uavcan_equipment_device_Temperature, return true on failure, false on
 success
*/
bool _uavcan_equipment_device_Temperature_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_device_Temperature *msg, bool tao) {
  (void)transfer;
  (void)bit_ofs;
...
struct uavcan_equipment_device_Temperature
sample_uavcan_equipment_device_Temperature_msg(void);
#endif
#ifdef __cplusplus
}  // extern "C"
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_equipment_device_Temperature,
