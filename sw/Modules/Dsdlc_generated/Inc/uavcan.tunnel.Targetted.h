...
uint32_t uavcan_tunnel_Targetted_encode(struct uavcan_tunnel_Targetted *msg,
                                        uint8_t *buffer
...
bool uavcan_tunnel_Targetted_decode(const CanardRxTransfer *transfer,
                                    struct uavcan_tunnel_Targetted *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_tunnel_Targetted_encode(
    uint8_t *buffer, uint32_t *bit_ofs, struct uavcan_tunnel_Targetted *msg,
    bool tao);
static inline bool _uavcan_tunnel_Targetted_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_tunnel_Targetted *msg, bool tao);
void _uavcan_tunnel_Targetted_encode(uint8_t *buffer, uint32_t *bit_ofs,
                                     struct uavcan_tunnel_Targetted *msg,
                                     bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
*/
bool _uavcan_tunnel_Targetted_decode(const CanardRxTransfer *transfer,
                                     uint32_t *bit_ofs,
                                     struct uavcan_tunnel_Targetted *msg,
                                     bool tao) {
  (void)transfer;
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_tunnel_Targetted, UAVCAN_TUNNEL_TARGETTED_ID,
                            UAVCAN_TUNNEL_TARGETTED_SIGNATURE,
                            UAVCAN_TUNNEL_TARGETTED_MAX_SIZE);
