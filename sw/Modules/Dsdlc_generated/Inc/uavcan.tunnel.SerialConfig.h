...
uint32_t uavcan_tunnel_SerialConfig_encode(
    struct uavcan_tunnel_SerialConfig *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_tunnel_SerialConfig_decode(const CanardRxTransfer *transfer,
                                       struct uavcan_tunnel_SerialConfig *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_tunnel_SerialConfig_encode(
    uint8_t *buffer, uint32_t *bit_ofs, struct uavcan_tunnel_SerialConfig *msg,
    bool tao);
static inline bool _uavcan_tunnel_SerialConfig_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_tunnel_SerialConfig *msg, bool tao);
void _uavcan_tunnel_SerialConfig_encode(uint8_t *buffer, uint32_t *bit_ofs,
                                        struct uavcan_tunnel_SerialConfig *msg,
                                        bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
*/
bool _uavcan_tunnel_SerialConfig_decode(const CanardRxTransfer *transfer,
                                        uint32_t *bit_ofs,
                                        struct uavcan_tunnel_SerialConfig *msg,
                                        bool tao) {
  (void)transfer;
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_tunnel_SerialConfig,
                            UAVCAN_TUNNEL_SERIALCONFIG_ID,
                            UAVCAN_TUNNEL_SERIALCONFIG_SIGNATURE,
                            UAVCAN_TUNNEL_SERIALCONFIG_MAX_SIZE);
