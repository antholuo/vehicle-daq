...
uint32_t uavcan_equipment_ahrs_SensorIMU_encode(
    struct uavcan_equipment_ahrs_SensorIMU *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_equipment_ahrs_SensorIMU_decode(
    const CanardRxTransfer *transfer,
    struct uavcan_equipment_ahrs_SensorIMU *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_equipment_ahrs_SensorIMU_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_ahrs_SensorIMU *msg, bool tao);
static inline bool _uavcan_equipment_ahrs_SensorIMU_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_ahrs_SensorIMU *msg, bool tao);
void _uavcan_equipment_ahrs_SensorIMU_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_ahrs_SensorIMU *msg, bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
/*
 decode uavcan_equipment_ahrs_SensorIMU, return true on failure, false on
 success
*/
bool _uavcan_equipment_ahrs_SensorIMU_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_ahrs_SensorIMU *msg, bool tao) {
  (void)transfer;
  (void)bit_ofs;
  ...
  *bit_ofs += 32;
  ...
  for (size_t i = 0; i < 3; i++) {
    canardDecodeScalar(transfer, *bit_ofs, 16, true,
...
struct uavcan_equipment_ahrs_SensorIMU
sample_uavcan_equipment_ahrs_SensorIMU_msg(void);
#endif
#ifdef __cplusplus
}  // extern "C"
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_equipment_ahrs_SensorIMU,
                            UAVCAN_EQUIPMENT_AHRS_SENSORIMU_ID,
                            UAVCAN_EQUIPMENT_AHRS_SENSORIMU_SIGNATURE,
                            UAVCAN_EQUIPMENT_AHRS_SENSORIMU_MAX_SIZE);
