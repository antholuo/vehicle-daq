...
static inline void _uavcan_equipment_gnss_SensorGPS_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_gnss_SensorGPS *msg, bool tao);
static inline bool _uavcan_equipment_gnss_SensorGPS_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_gnss_SensorGPS *msg, bool tao);
void _uavcan_equipment_gnss_SensorGPS_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_equipment_gnss_SensorGPS *msg, bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
/*
 decode uavcan_equipment_gnss_SensorGPS, return true on failure, false on
 success
*/
bool _uavcan_equipment_gnss_SensorGPS_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_equipment_gnss_SensorGPS *msg, bool tao) {
  (void)transfer;
  (void)bit_ofs;
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_equipment_gnss_SensorGPS,
                            UAVCAN_EQUIPMENT_GNSS_SENSORGPS_ID,
                            UAVCAN_EQUIPMENT_GNSS_SENSORGPS_SIGNATURE,
                            UAVCAN_EQUIPMENT_GNSS_SENSORGPS_MAX_SIZE);
