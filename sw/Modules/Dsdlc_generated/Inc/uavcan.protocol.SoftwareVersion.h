...
uint32_t uavcan_protocol_SoftwareVersion_encode(
    struct uavcan_protocol_SoftwareVersion *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_protocol_SoftwareVersion_decode(
    const CanardRxTransfer *transfer,
    struct uavcan_protocol_SoftwareVersion *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_protocol_SoftwareVersion_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_protocol_SoftwareVersion *msg, bool tao);
static inline bool _uavcan_protocol_SoftwareVersion_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_protocol_SoftwareVersion *msg, bool tao);
void _uavcan_protocol_SoftwareVersion_encode(
    uint8_t *buffer, uint32_t *bit_ofs,
    struct uavcan_protocol_SoftwareVersion *msg, bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
/*
 decode uavcan_protocol_SoftwareVersion, return true on failure, false on
 success
*/
bool _uavcan_protocol_SoftwareVersion_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_protocol_SoftwareVersion *msg, bool tao) {
  (void)transfer;
  (void)bit_ofs;
...
struct uavcan_protocol_SoftwareVersion
sample_uavcan_protocol_SoftwareVersion_msg(void);
#endif
#ifdef __cplusplus
}  // extern "C"
