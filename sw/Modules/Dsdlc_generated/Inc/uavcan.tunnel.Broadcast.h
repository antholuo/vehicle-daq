...
uint32_t uavcan_tunnel_Broadcast_encode(struct uavcan_tunnel_Broadcast *msg,
                                        uint8_t *buffer
...
bool uavcan_tunnel_Broadcast_decode(const CanardRxTransfer *transfer,
                                    struct uavcan_tunnel_Broadcast *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_tunnel_Broadcast_encode(
    uint8_t *buffer, uint32_t *bit_ofs, struct uavcan_tunnel_Broadcast *msg,
    bool tao);
static inline bool _uavcan_tunnel_Broadcast_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_tunnel_Broadcast *msg, bool tao);
void _uavcan_tunnel_Broadcast_encode(uint8_t *buffer, uint32_t *bit_ofs,
                                     struct uavcan_tunnel_Broadcast *msg,
                                     bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
*/
bool _uavcan_tunnel_Broadcast_decode(const CanardRxTransfer *transfer,
                                     uint32_t *bit_ofs,
                                     struct uavcan_tunnel_Broadcast *msg,
                                     bool tao) {
  (void)transfer;
  ...
  if (_uavcan_tunnel_Protocol_decode(transfer, bit_ofs, &msg->protocol,
                                     false)) {
    return true;
  }
...
BROADCAST_MESSAGE_CXX_IFACE(uavcan_tunnel_Broadcast, UAVCAN_TUNNEL_BROADCAST_ID,
                            UAVCAN_TUNNEL_BROADCAST_SIGNATURE,
                            UAVCAN_TUNNEL_BROADCAST_MAX_SIZE);
