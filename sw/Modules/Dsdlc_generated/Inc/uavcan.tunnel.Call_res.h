...
uint32_t uavcan_tunnel_CallResponse_encode(
    struct uavcan_tunnel_CallResponse *msg, uint8_t *buffer
#if CANARD_ENABLE_TAO_OPTION
    ,
    bool tao
#endif
);
bool uavcan_tunnel_CallResponse_decode(const CanardRxTransfer *transfer,
                                       struct uavcan_tunnel_CallResponse *msg);

#if defined(CANARD_DSDLC_INTERNAL)

static inline void _uavcan_tunnel_CallResponse_encode(
    uint8_t *buffer, uint32_t *bit_ofs, struct uavcan_tunnel_CallResponse *msg,
    bool tao);
static inline bool _uavcan_tunnel_CallResponse_decode(
    const CanardRxTransfer *transfer, uint32_t *bit_ofs,
    struct uavcan_tunnel_CallResponse *msg, bool tao);
void _uavcan_tunnel_CallResponse_encode(uint8_t *buffer, uint32_t *bit_ofs,
                                        struct uavcan_tunnel_CallResponse *msg,
                                        bool tao) {
  (void)buffer;
  (void)bit_ofs;
...
*/
bool _uavcan_tunnel_CallResponse_decode(const CanardRxTransfer *transfer,
                                        uint32_t *bit_ofs,
                                        struct uavcan_tunnel_CallResponse *msg,
                                        bool tao) {
  (void)transfer;
